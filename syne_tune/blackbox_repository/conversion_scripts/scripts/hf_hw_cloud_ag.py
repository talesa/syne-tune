...
class NASBench201CloudBlackbox(Blackbox):
    def __init__(self, bb):
        ...
        self.bb = bb
        super(NASBench201CloudBlackbox, self).__init__(
...
def instance_speed_cost(max_instance: int = None) -> Dict[str, Tuple[float, float]]:
    ...
    # p2.xlarge's k80s are ~4 times slower than 1080ti that were used to acquire nas201
    df[time_col] *= 4
...
def generate_nas201_cloud():
    ...
    bb_dict = {
        task: NASBench201CloudBlackbox(bb=bb)
