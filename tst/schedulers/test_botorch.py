...
from syne_tune.optimizer.schedulers.botorch.encode_decode_utils import decode_config, encode_config
...
def test_featurize():
    ...
    for _ in range(3):
        ...
        feature_vector = encode_config(config_space, config, categorical_maps)

        config_reconstructed = decode_config(
