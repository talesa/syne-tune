...
from blackbox_repository.serialize import serialize_configspace, deserialize_configspace, serialize_metadata, \
...
class BlackboxOffline(Blackbox):
    def __init__(
        ...
        :param name: name of the blackbox, for instance "Nas201"
